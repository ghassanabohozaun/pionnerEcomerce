    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header  mb-2">
                <h5 class="modal-title test_answer_header" id="createCategoryModalLabel">{!! __('categories.create_new_category') !!}</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control border-primary" id='parent'
                                                    name="parent">
