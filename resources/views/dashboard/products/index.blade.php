                                                    ...
                                                    <table id="yajra-datatable" class="table table-striped table-bordered">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>{!! __('products.category_id') !!}</th>
                                                                <th>{!! __('products.brand_id') !!}</th>
                                                                <th>{!! __('products.sku') !!}</th>
                                                                <th>{!! __('products.available_for') !!}</th>
                                                                <th>{!! __('products.price') !!}</th>
                                                                <th>{!! __('products.quantity') !!}</th>
                                                                <th>{!! __('general.created_at') !!}</th>
                                                                <th>{!! __('products.status') !!}</th>
                                                                <th>{!! __('products.manage_status') !!}</th>
...
@push('scripts')
    <script type="text/javascript">
        ...
        var table = $('#yajra-datatable').DataTable({
            ...
            ajax: '{!! route('dashboard.products.get.all') !!}',
        ...
        $('body').on('change', '.change_status', function(e) {
            ...
            $.ajax({
                url: "{{ route('dashboard.products.change.status') }}",
                data: {
