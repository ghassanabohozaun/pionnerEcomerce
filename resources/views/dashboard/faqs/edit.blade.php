...
@section('content')
    <div class="app-content content">
        ...
        <form class="form" action="{!! route('dashboard.faqs.update', $faq->id) !!}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                                        ...
                                                        <div class="form-group">
                                                            <label id="statusLabel">
                                                                <input type="checkbox" name="status" class="checkbox"
                                                                    @checked(old('status', $faq->status) == 'on')>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" id="answer" name="answer[ar]" class="form-control round border-primary "
                                                                placeholder="{!! __('faqs.enter_answer_ar') !!}">{!! old('answer.ar', $faq->getTranslation('answer', 'ar')) !!}</textarea>
                                                            @error('answer.ar')
                                                                <span class="text text-danger">
                                                                    <strong>{!! $message !!}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" id="answer" name="answer[en]" class="form-control round border-primary "
                                                                placeholder="{!! __('faqs.enter_answer_en') !!}">{!! old('answer.en', $faq->getTranslation('answer', 'en')) !!}</textarea>
                                                            @error('answer.en')
                                                                <span class="text text-danger">
                                                                    <strong>{!! $message !!}</strong>
                                                                </span>
