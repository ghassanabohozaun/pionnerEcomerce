<div class="col-xl-12 col-lg-12 mb-1">
    <div class="form-group text-center">
        ...
        <a href="#"
            class="btn btn-social-icon btn-sm mr-1 btn-round  btn-outline-warning get_all_cities_by_governorate_btn"
            data-id="{!! $governorate->id !!}" title="{!! __('world.show_all_cities') !!}">
            <i class="la la-eye"></i>
        </a>
