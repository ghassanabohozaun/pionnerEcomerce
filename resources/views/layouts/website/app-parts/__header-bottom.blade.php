                                ...
                                <div class="dropdown-item">
                                    <div class="dropdown-list-item">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/dresses.webp"
                                                alt="dress">
                                        </span>
                            ...
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/bags.webp"
                                                alt="Bags">
                                        </span>
                                        <span class="dropdown-text">
                                            Bags
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/sweaters.webp"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Sweaters
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/shoes.webp"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Boots
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/gift.webp"
                                                alt="gift">
                                        </span>
                                        <span class="dropdown-text">
                                            Gifts
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/sneakers.webp"
                                                alt="sneakers">
                                        </span>
                                        <span class="dropdown-text">
                                            Sneakers
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/watch.webp"
                                                alt="watch">
                                        </span>
                                        <span class="dropdown-text">
                                            Watches
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/ring.webp"
                                                alt="ring">
                                        </span>
                                        <span class="dropdown-text">
                                            Gold Ring
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/cap.webp"
                                                alt="cap">
                                        </span>
                                        <span class="dropdown-text">
                                            Cap
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/glass.webp"
                                                alt="glass">
                                        </span>
                                        <span class="dropdown-text">
                                            Sunglasses
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/category-img/baby.webp"
                                                alt="baby">
                                        </span>
                                        <span class="dropdown-text">
                                            Baby Shop
                    ...
                    <li class="mega-menu">
                        ...
                        <div class="shop-menu">
                            ...
                            <div class="shop-menu-img">
                                <img src="{!! asset('assets/website/images/') !!}/homepage-one/empty-wishlist.webp" alt="img">
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="header-sub-menu">
                            @foreach ($pages as $page)
                                <li><a href="{!! route('website.get.daynamic.page', $page->slug) !!}">{!! $page->title !!}</a></li>
                            @endforeach
