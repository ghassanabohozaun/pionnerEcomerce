                                                        ...
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-19.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-18.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-17.png"
                                                                    alt="Avatar">
                                                            </li>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-16.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-15.png"
                                                                    alt="Avatar">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-11.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-10.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-9.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li class="avatar avatar-sm">
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-14.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-13.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-12.png"
                                                                    alt="Avatar">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-8.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-7.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-6.png"
                                                                    alt="Avatar">
                                                            </li>
                                                            <li class="avatar avatar-sm">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2"
                                                            src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-4.png"
                                                            alt="avatar">
                                                    </span>
                                                    ...
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-1.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            data-original-title="Willie Torres"
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-2.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            data-original-title="Rebecca Jones"
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-4.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                            <span class="badge badge-info">+1 more</span>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2"
                                                            src="{!! asset('assets/dashbaord') !!}/images/portrait/small/avatar-s-5.png"
                                                            alt="avatar">
                                                    </span>
                                                    <span>Doris R.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-5.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            data-original-title="Willie Torres"
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-6.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                ...
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        ...
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                                src="{!! asset('assets/dashbaord') !!}/images/portfolio/portfolio-3.jpg"
                                                                alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </td>
                ...
                <div class="row match-height">
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="{!! asset('assets/dashbaord') !!}/images/carousel/05.jpg"
                                    alt="Card image cap">
                                <div class="card-body">
