    ...
    <section class="blog about-blog">
        <div class="container">
            ...
            <div class="blog-heading about-heading">
                <h1 class="heading">User Dashboard {!! Auth::guard('admin')->check() !!} 111</h1>
            </div>
        </div>
    </section>
                                        ...
                                        <div class="img-upload-section">
                                            <div class="logo-wrapper">
                                                ...
                                                <div class="logo-upload">
                                                    <img src="{!! asset('assets/website/images/') !!}/homepage-one/sallers-cover.png"
                            ...
                            <div class="payment-section">
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/payment-img-1.png"
                                                alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/payment-img-2.png"
                                                alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/payment-img-3.png"
                                                alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{!! asset('assets/website/images/') !!}/homepage-one/payment-img-4.png"
                                                alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                        ...
                                        <div class="login-section account-section modal-main">
                                            <div class="review-form">
                                                <div class="review-content">
                                                    ...
                                                    <div class="close-btn">
                                                        <img src="{!! asset('assets/website/images/') !!}/homepage-one/close-btn.png"
                            ...
                            <div class="top-selling-section">
                                <div class="row g-5">
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <img src="{!! asset('assets/website/images/') !!}/homepage-one/product-img/product-img-5.webp"
                                                    alt="product-img">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <img src="{!! asset('assets/website/images/') !!}/homepage-one/product-img/product-img-6.webp"
                                                    alt="product-img">
                                            </div>
                                            <div class="product-info">
                                                <div class="review-date">
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <img src="{!! asset('assets/website/images/') !!}/homepage-one/product-img/product-img-7.webp"
                                                    alt="product-img">
                                            </div>
                                            <div class="product-info">
                                                <div class="review-date">
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <img src="{!! asset('assets/website/images/') !!}/homepage-one/product-img/product-img-8.webp"
                                                    alt="product-img">
                                            </div>
                                            <div class="product-info">
                                                <div class="review-date">
