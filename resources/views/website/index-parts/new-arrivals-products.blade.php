@if (!empty($homePageProducts['newArrivalsProducts']))
    <section class="product arrival">
        <div class="container">
            <div class="section-title">
                <h5>{!! __('website.new_arrival') !!}</h5>
                <a href="{!! route('website.products.get.by.type', 'new-arrivals-products') !!}" class="view">{!! __('website.view_all') !!}</a>
            </div>
            <div class="arrival-section">
                <div class="row g-5">
                    @foreach ($homePageProducts['newArrivalsProducts'] as $product)
                        <div class="col-lg-3 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                <div class="product-img">
                                    <img src="{!! asset('uploads/products/' . $product->images()->first()->file_name) !!}" alt="product-img">
                                    <div
                                ...
                                <div class="product-cart-btn">
                                    <a href="{!! route('website.products.by.category', $product->category->slug) !!}" class="product-btn">{!! $product->category->name !!}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
