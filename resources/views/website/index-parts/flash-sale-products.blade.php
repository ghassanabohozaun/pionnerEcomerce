@if (!empty($homePageProducts['flashSaleProducts']))
    <section class="product best-product pt-5">
        <div class="container">
            <div class="section-title">
                <h5>{!! __('website.flash_sale') !!}</h5>
                <a href="{!! route('website.products.get.by.type', 'flash-products') !!}" class="view">{!! __('website.view_all') !!}</a>
            </div>
            <div class="best-product-section">
                <div class="row g-4">
                    @foreach ($homePageProducts['flashSaleProducts'] as $product)
                            ...
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{!! route('website.products.show.page', $product->slug) !!}"
