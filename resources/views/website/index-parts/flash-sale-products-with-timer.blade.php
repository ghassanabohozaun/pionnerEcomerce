@if ($homePageProducts['flashSaleProductsWithTimer']->count() > 0)
    <section class="product flash-sale">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{!! route('website.products.get.by.type', 'timer-products') !!}" class="view">{!! __('website.view_all') !!}</a>
            </div>
            <div class="flash-sale-section">
                <div class="row g-5">
                    @foreach ($homePageProducts['flashSaleProductsWithTimer'] as $product)
