                        ...
                        <div class="row g-5">
                                    ...
                                    <div class="product-wrapper" data-aos="fade-up">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-description">
                                                <a href="javascript:void(0)" class="product-details">
                                                    {!! $product->name !!}
                                                </a>
                                                <div class="price">
                                        ...
                                        <div class="product-cart-btn">
                                            <a href="javascript:void(0)" class="product-btn">{!! __('website.add_to_cart') !!}</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @empty
                                <div class="d-flex justify-content-center margin-top-40">
                                    <h5 class="text text-danger mt-5 pt-5">
                                        {!! __('website.no_products') !!}
                                    </h5>
                                </div>
                            @endforelse
