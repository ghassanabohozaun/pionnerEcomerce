...
@section('content')
    ...
    @if (!empty($products))
        <section class="product product-sidebar  @if ($productType) flash-sale @endif footer-padding">
            <div class="container">
                @if ($productType)
                                        ...
                                        <div class="product-wrapper" data-aos="fade-up">
                                            <div class="product-img">
                                                ...
                                                <div class="product-cart-items">
                                                    <a href="{!! route('website.products.show.page', $product->slug) !!}" class="cart cart-item">
                                                        <span>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="{!! route('website.products.show.page', $product->slug) !!}" class="product-details">
                                                        {!! $product->name !!}
                                                    </a>
                                                    <div class="price">
                                                        @if ($product->has_variants)
                                                            <span class="new-price text-warning">{!! __('website.has_variants') !!}
                                                            </span>
                                                        @else
                                                            @if ($product->has_discount)
                                                                <span class="price-cut">{!! $product->price !!}
                                                                    {!! __('website.sar') !!}
                                                                </span>
                                            ...
                                            <div class="product-cart-btn">
                                                <a href="javascript:void(0)"
                                                    class="product-btn">{!! __('website.add_to_cart') !!}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach

                                <div class="d-flex justify-content-center margin-top-40">
                                    {{ $products->links() }}
                                </div>
            ...
            <div class="container">
                <div class="blog-item" data-aos="fade-up">
                    ...
                    <div class="cart-content">
                        <p class="content-title">{!! __('website.empty_you_dont_have_any_products') !!} </p>
                        <a href="#" class="shop-btn">{!! __('website.back_to_shop') !!}</a>
                    </div>
                </div>
            </div>
        </section>
...
@push('script')
    @if ($productType)
        <script src="{!! asset('assets\website\js\flash-timer-products.js') !!}"></script>
    @endif
@endpush
